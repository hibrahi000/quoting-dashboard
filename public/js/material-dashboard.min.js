(isWindows = -1 < navigator.platform.indexOf('Win')),
	isWindows
		? ($('.sidebar .sidebar-wrapper, .main-panel').perfectScrollbar(), $('html').addClass('perfect-scrollbar-on'))
	...
	(md = {
		...
		checkSidebarImage: function() {
			($sidebar = $('.sidebar')),
				...
				void 0 !== image_src &&
					((sidebar_container =
						'<div class="sidebar-background" style="background-image: url(' + image_src + ') "/>'),
		...
		checkFullPageBackgroundImage: function() {
			($page = $('.full-page')),
				...
				void 0 !== image_src &&
					((image_container =
						'<div class="full-page-background" style="background-image: url(' + image_src + ') "/>'),
		...
		initMinimizeSidebar: function() {
			$('#minimizeSidebar').click(function() {
				...
				1 == md.misc.sidebar_mini_active
					? ($('body').removeClass('sidebar-mini'), (md.misc.sidebar_mini_active = !1))
					: ($('body').addClass('sidebar-mini'), (md.misc.sidebar_mini_active = !0));
